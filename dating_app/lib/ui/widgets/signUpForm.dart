...
import 'package:chill/bloc/authentication/bloc.dart';
...
class _SignUpFormState extends State<SignUpForm> {
  ...
  bool get isPopulated =>_emailController.text.isNotEmpty &&
    ...
    bool isSignUpButtonEnabled(SignUpState signUpState){
      return isPopulated && !signUpState.isSubmitting;
    }
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child:TextFormField (
                      ...
                      obscureText: true,
                      validator: (_){
                        return !state.isPasswordValid ?"Password too weak! ":null;
                      },
                      decoration:InputDecoration(
                        labelText: "Password",
                        labelStyle: TextStyle(
