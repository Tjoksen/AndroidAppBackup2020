...
public class SettinsActivity extends AppCompatActivity
{
    ...
    public void permissions(){
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE)== PackageManager.PERMISSION_GRANTED){
            Toast.makeText(SettinsActivity.this, "Permission already granted", Toast.LENGTH_SHORT).show();
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ActivityCompat.requestPermissions(SettinsActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);
                            }
                        })
