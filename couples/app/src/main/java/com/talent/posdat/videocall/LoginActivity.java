package com.talent.posdat.videocall;
...
public class LoginActivity extends BaseActivity implements SinchService.StartFailedListener {
   ...
   private String myUserName, colRecieverName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //myusername
        myUserName=  getIntent().getStringExtra("myId");
        //receivername
        colRecieverName=  getIntent().getStringExtra("receiverId");
    ...
    private void openPlaceCallActivity() {
        ...
        mainActivity.putExtra("receiverId",colRecieverName);
